---
title: Patient Request Fields (Updated Fields)
excerpt: ''
deprecated: false
hidden: true
metadata:
...
| :------------------ | :-------- | :-------------- | :---------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| patientKey          | String    | 30              | Required          | Unique patient ID in Client system.                                                                                                                                                                                                                                                                                                           |
...
| address             | Object    |                 | Required          | Object containing patient’s address information. See [Address](doc:patient-request-fields#address) table.                                                                                                                                                                                                                                     |
| contact             | Object    |                 | Required          | Object containing patient’s contact information. See [Contact](doc:patient-request-fields#contact) table.                                                                                                                                                                                                                                     |
| allergies           | Array     |                 | Required          | Array containing patient’s allergy information. See the [Allergies](doc:patient-request-fields#allergies) table for valid list of allergies.                                                                                                                                                                                                  |
