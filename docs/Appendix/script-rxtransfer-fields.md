...
| prescription      | Object [prescription](https://docs.healthdyne.com/docs/script-rxtransfer-fields#prescription)  |                 | Required          | Contains the prescription information.                                                                                                                                                   |
...
| quantityDispensedToDate    | Decimal                                                                                   |                 | Optional          | Field is required if orTransfer is True. Total quantity dispensed so far.                   |
| remainingQuantity          | Decimal                                                                                   |                 | Optional          | Field is required if orTransfer is True. Remaining quantity left to dispense.               |
...
| lastFillDate               | String                                                                                    | 10              | Optional          | Field is required if orTransfer is True. Date of the last fill, if any.                     |
| firstFillDate              | String                                                                                    | 10              | Optional          | Field is required if orTransfer is True. Date of the first fill.                            |
| fillsToDate                | Integer                                                                                   |                 | Optional          | Field is required if orTransfer is True. Number of fills already made.                      |
| refillsAuthorized          | Integer                                                                                   |                 | Required          | Total refills authorized by the prescriber.                                                 |
| refillsLeft                | Integer                                                                                   |                 | Optional          | Field is required if orTransfer is True. Refills remaining.                                 |
| refillsTransferred         | Integer                                                                                   |                 | Optional          | Field is required if orTransfer is True. Number of refills transferred to another pharmacy. |
...
| firstFillDispensedQuantity | Decimal                                                                                   |                 | Optional          | Field is required if orTransfer is True. Quantity dispensed on the first fill.              |
| currentFillNumber          | Integer                                                                                   |                 | Optional          | Field is required if orTransfer is True. Fill number of the current dispense action.        |
...
| :----------- | :------------------------------------------------------------------------------------------------------------ | :-------------- | :---------------- | :---------------------------------------------------------------------------------------------------- |
| scriptKey    | String                                                                                                        | 50              | Required          |                                                                                                       |
| prescription | Object [prescription](https://docs.healthdyne.com/docs/script-rxtransfer-fields#prescription-response-detail) |                 | Required          | See [Prescription Response Detail](doc:script-rxtransfer-fields#prescription-response-detail)  table. |
...
| provider             | Object [provider](https://docs.healthdyne.com/docs/script-rxtransfer-fields#provider)                          |                 | Information about the prescribing provider. Object containing provider  information. |
| supervisor           | Object [supervisor](https://docs.healthdyne.com/docs/script-rxtransfer-fields#supervisor)                      |                 | Optional supervisor information. Object containing  supervisor information.          |
...
| fulfillingPharmacy | Object [fulfillingPharmacy](https://docs.healthdyne.com/docs/script-rxtransfer-fields#fulfilling-pharmacy) |                  | Required          | Contains information about the pharmacy to which the fax will be sent                                                                                                                 |
