...
| :--------- | :----------------------------------------------------------------------------------------------------------- | :-------------- | :---------------- | :------------------------------------------------- |
| patientKey | String                                                                                                       | 50              | Required          | Unique patient ID in Client system.                |
| insurance  | Object[[InsuranceDataObject](https://docs.healthdyne.com/docs/insurance-request-fields#insurancedataobject)] |                 | Required          | Object containing patient's insurance information. |
...
| relationshipCode  | String | 1               | Optional          | Number 0 to 9. See relationship code table [[below](https://docs.healthdyne.com/docs/insurance-request-fields#relationship-codes)] |
