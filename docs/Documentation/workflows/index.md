...
3. Query Script API using scriptKey to retrieve prescription details [Script API Guide](doc:script-rxtransfer-request)
4. Generate fill request using Fill API [Fill API Guide](docs:fill-request)Retrieve status updates via Mailbox API [Mailbox API Guide](docs:mail-box)
5.
...
2. Submit Rx Transfer via Script API [Script API Guide](docs:script-rxtransfer-request)
3. Generate fill request using Fill API once RxTransferred notification is received [Fill API Guide](docs:fill-request)
4. Retrieve status updates via Mailbox API [Mailbox API Guide](docs:mail-box)
