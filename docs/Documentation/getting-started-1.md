...
The diagram below represents how [New Prescription](https://docs.healthdyne.com/docs/new-prescription-request) request and [Order Status](https://docs.healthdyne.com/docs/order-status) request will be received from partners and will flow through HealthDyne systems.

![](https://files.readme.io/875a11e-image.png)

<br />

<br />

The diagram below represents how [Refill Prescription Request](doc:refill-prescription-request) will be received and processed through HealthDyne systems.

<Image align="center" src="https://files.readme.io/e111c64-image.png" />
